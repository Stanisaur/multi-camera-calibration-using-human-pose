...
Qt creator is required and cmakelists.txt must be configured to get Qt 6.10, eigen, poselib and onnxruntime linked on your system properly. You can leave cmakelists.txt as it is and simply ensure that your env can find the required header files, shared libraries and binaries
...
3. USB bandwidth and buffer overflow - depending on your hardware, a given usb hub can only support a given amount of bits per second, if you have 2 HD webcams streaming at 30fps, it can easily consume all available bandwidth and lead to confusing behaviours. If you see duplication of camera feeds or visual artifacts, this is very likely the cause.
